...
class DonorProfile(models.Model):
    ...
    mobile_number = models.CharField("Contact Number (+91xxxxxxxxxx)", validators=[phone_regex], max_length=15,
                                     blank=True)
...
class HospitalProfile(models.Model):
    ...
    hospital_address = models.TextField("Hospital Address", max_length=500, null=True, blank=True)
