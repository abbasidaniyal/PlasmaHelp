    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.FileField(null=True, upload_to='', validators=[users.validators.validate_file_extension])),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_address', models.TextField(max_length=500, null=True)),
                ('location', models.CharField(max_length=30, null=True)),
                ...
                ('mci_registeration_number', models.CharField(max_length=50, null=True)),
            ],
        ),
    ]
